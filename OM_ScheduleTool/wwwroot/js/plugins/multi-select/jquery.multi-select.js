...
;(function($) {
  ...
  $.extend(MultiSelect.prototype, {
    ...
    //      //        this.$button.attr("title", selected);
    //      //    }
    //      //    else {
    //      //        $($($("#" + $($(this.$element).context).attr("id")).parent()).find("input")).prop("checked", true);
    //      //        $("#hdnNetworkSelection").val('all');
    //      //        this.$button.text("All Selected");
    //      //        this.$button.attr("title", "All Selected");
    //      //    }
    //      //}
    //      //else {
    //      //    if (selected[0] != "All") {
    //      //        this.$button.text(selected.length + ' selected');
    //      //        this.$button.attr("title", selected.join(', '));
    //      //    }
    //      //    else {
    //      //        $($($("#" + $($(this.$element).context).attr("id")).parent()).find("input")).prop("checked", true);
    //      //        $("#hdnNetworkSelection").val('all');
    ...
    menuShow: function() {
        ...
        if ($($(this.$container).find("span")).attr("disabled") == "disabled") {
            return false;
        }
